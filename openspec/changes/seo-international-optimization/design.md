...
1. **Phase 1 (this session)**: update `lang/*/app.php` hero + SEO-text keys and `config/apartment.php` `seo.*` title/description for all 4 locales; no schema/route changes, fully reversible via git.
2. **Phase 2**: add `trust_badges` config array + lang keys + new homepage section.
