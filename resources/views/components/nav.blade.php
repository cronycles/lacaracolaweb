...
<nav class="nav" aria-label="Main navigation">
    <div class="container nav__inner">
        ...
        {{-- Logo --}}
        <a href="{{ route('home') }}" class="nav__logo" aria-label="{{ config('apartment.name') }}">
            <span>{{ config('apartment.name') }}</span>
        </a>

        {{-- Desktop links --}}
        <ul class="nav__links" role="list">
            <li><a href="{{ route('home') }}"         class="nav__link @active('home')">{{ __('app.nav_home') }}</a></li>
            <li><a href="{{ route('apartment') }}"    class="nav__link @active('apartment')">{{ __('app.nav_apartment') }}</a></li>
...
<nav class="nav-mobile" id="mobile-menu" aria-label="Mobile navigation">
    <a href="{{ route('home') }}">{{ __('app.nav_home') }}</a>
    <a href="{{ route('apartment') }}">{{ __('app.nav_apartment') }}</a>
