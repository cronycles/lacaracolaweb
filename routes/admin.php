...
Route::middleware(['auth'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('permission:manage_bookings')->group(function () {
        ...
        Route::get('/prenotazioni/{prenotazioni}/email-preview/{emailType}', [BookingController::class, 'previewEmail'])
            ->where('emailType', 'confirmation|host-keeper|payment-received|checkin-reminder|checkin-completed|review-request')
    ...
    Route::middleware('permission:manage_pricing')->group(function () {
        ...
        Route::get('/sconti-soggiorno', [StayDiscountRuleController::class, 'index'])->name('stay-discounts.index');
    });
