...
- Keep outputs compatible with the project documentation flow in `docs/`
...
At the end of the process, always write your conclusions in the markdown file `docs/agent_outputs/market-research-analyst.md`.
